            ...
            <div className='container'>
                <div className='recentPosts'>
                    ...
                    <div className='recentPost'>
                        ...
                        <h3 className='pic_title'>Exploring My <br/>Surroundings</h3>
                    ...
                    <div className='recentPost'>
                        ...
                        <h3 className='pic_title'>Travel on a low <br/>budget</h3>
                    ...
                    <div className='recentPost'>
                        ...
                        <h3 className='pic_title'>Hiking in<br/> the woods</h3>
